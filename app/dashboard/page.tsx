            ...
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem className="hidden md:block">
                  <BreadcrumbLink href="#">Postgen AI</BreadcrumbLink>
                </BreadcrumbItem>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Collaborating on content</p>
              </CardContent>
            </Card>
          </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { title: "LinkedIn Post - Product Launch", type: "Social Media", time: "2 hours ago" },
                    { title: "Email Campaign - Newsletter", type: "Email", time: "5 hours ago" },
                    { title: "Instagram Carousel - Features", type: "Visual", time: "1 day ago" },
                  ].map((item, index) => (
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    { name: "Brand Awareness Campaign", progress: 45, status: "In Progress" },
                    { name: "Holiday Campaign", progress: 20, status: "Planning" },
                  ].map((project, index) => (
