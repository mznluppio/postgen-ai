...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <div
      className={cn(
        "w-full relative h-12 rounded-md overflow-hidden shadow transition duration-200",
        value && "bg-gray-50",
      )}
    >
      <canvas
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full h-full text-sm sm:text-base z-50 border-none dark:text-white bg-transparent text-black focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-28",
